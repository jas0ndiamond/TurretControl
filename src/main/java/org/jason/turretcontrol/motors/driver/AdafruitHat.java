 ...
 * 
 * @author Eric Eliason
 * @see org.jason.turretcontrol.motors.driver.adafruithat.AdafruitMotorHat
...
public  class AdafruitHat {
	 ...
	 */
	public AdafruitHat(int deviceAddr) throws UnsupportedBusNumberException {
	 ...
	 * @throws UnsupportedBusNumberException 
	 */
	public AdafruitHat(int deviceAddr, int i2cBus) throws UnsupportedBusNumberException {
		checkDeviceAddr(deviceAddr);
		DEVICE_ADDR = deviceAddr;
		checkBus(i2cBus);
		I2C_BUS = i2cBus;
	 ...
	 * @throws UnsupportedBusNumberException 
	 */
	private void setup() throws UnsupportedBusNumberException {	
		try {
