 ...
 *
 * @author Eric Eliason
 * @see org.jason.turretcontrol.motors.driver.adafruithat.AdafruitHat
 */
public class AdafruitMotorHat extends AdafruitHat {
	
	private double maxFreq = 1526;
	
	public final static String STEPPER_MOTOR_1 = "SM1";
	public final static String STEPPER_MOTOR_2 = "SM2";
	...
	{
		stepperMotorAllocated.put(STEPPER_MOTOR_1,false);
		stepperMotorAllocated.put(STEPPER_MOTOR_2,false);
	}	
