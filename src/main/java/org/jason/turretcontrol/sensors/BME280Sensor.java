...
public abstract class BME280Sensor
{
	...
	public static double[] getReading(int bus, int address) throws IOException, UnsupportedBusNumberException
	{  
        I2CBus i2cBus = I2CFactory.getInstance(bus);
        // Get I2C device, BME280App I2C address is 0x76(108)
        I2CDevice i2cDevice = i2cBus.getDevice(address);
			
        // Read 24 bytes of data from address 0x88(136)
        byte[] b1 = new byte[24];
        i2cDevice.read(0x88, b1, 0, 24);
        ...
        int dig_H1 = ((byte)i2cDevice.read(0xA1) & 0xFF);
        
        // Read 7 bytes of data from address 0xE1(225)
        i2cDevice.read(0xE1, b1, 0, 7);
        ...
        i2cDevice.write(0xF2 , (byte)0x01);
        // Select control measurement register
        // Normal mode, temp and pressure over sampling rate = 1
        i2cDevice.write(0xF4 , (byte)0x27);
        // Select config register
        // Stand_by time = 1000 ms
        i2cDevice.write(0xF5 , (byte)0xA0);
        
        // Read 8 bytes of data from address 0xF7(247)
        // pressure msb1, pressure msb, pressure lsb, temp msb1, temp msb, temp lsb, humidity lsb, humidity msb
        byte[] data = new byte[8];
        i2cDevice.read(0xF7, data, 0, 8);
		...
		return new double[]{cTemp, fTemp, pressure, humidity};
    }
	...
	public static void main(String[] args)
	{
		...
		for(int i=0; i< 10; i++)
		{
			try 
			{
				reading = BME280Sensor.getReading(1, 0x77);
				
				System.out.println("Temperature(C): " + reading[0]);
				System.out.println("Temperature(F): " + reading[1]);
				System.out.println("Pressure(hPa): " + reading[2]);
				System.out.println("Relative Humidity(%): " + reading[3]);
